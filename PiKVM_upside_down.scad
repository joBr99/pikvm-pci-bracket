...
difference() {
    union(){
        ...
        rpipillar(pcb_length(RPI4)-3,0,-8);
        rpipillar(pcb_length(RPI4)-3,0,-pcb_width(RPI4)-1);
        rpipillar(+24,0,-pcb_width(RPI4)-1);
        rpipillar(+24,0,-8);
        rpipillar(+3.8,0,-pcb_width(RPI4)-11);
        rpipillar(pcb_length(B101)-2.6,0,-pcb_width(RPI4)-11);
        rpipillar(pcb_length(B101)-2.6,0,-pcb_width(RPI4)-pcb_width(B101)-4.8);
        rpipillar(+3.8,0,-pcb_width(RPI4)-pcb_width(B101)-4.8);


        translate([pcb_length(B101)+4.5,0,-pcb_width(RPI4)-9])
        bbpillar();
        translate([pcb_length(B101)+4.5,0,-pcb_width(RPI4)-pcb_width(B101)-6.5])
        bbpillar();
        translate([pcb_length(B101)+4.5+28.5,0,-pcb_width(RPI4)-9])
        bbpillar();
        translate([pcb_length(B101)+4.5+28.5,0,-pcb_width(RPI4)-pcb_width(B101)-6.5])
        bbpillar();

    }
    translate([(pcb_length(RPI4) / 2) + .52, -1.5, -(pcb_width(RPI4) / 2) - sv07]) {
        rotate([90, 180, 0])
        pcb(RPI4);
        //pcb_cutouts(RPI4);
    ...
    translate([(pcb_length(B101) / 2) + .52, -1.5, -(pcb_width(B101) / 2) - 7.75 - pcb_width(RPI4)]) {
        rotate([90, 180, 0])
        pcb(B101);
        //pcb_cutouts(B101);
    ...
    rpipillarhole(pcb_length(RPI4)-3,0,-8);
    rpipillarhole(pcb_length(RPI4)-3,0,-pcb_width(RPI4)-1);
    rpipillarhole(+24,0,-pcb_width(RPI4)-1);
    rpipillarhole(+24,0,-8);
    rpipillarhole(+3.8,0,-pcb_width(RPI4)-11);
    rpipillarhole(pcb_length(B101)-2.6,0,-pcb_width(RPI4)-11);
    rpipillarhole(pcb_length(B101)-2.6,0,-pcb_width(RPI4)-pcb_width(B101)-4.8);
    rpipillarhole(+3.8,0,-pcb_width(RPI4)-pcb_width(B101)-4.8);
